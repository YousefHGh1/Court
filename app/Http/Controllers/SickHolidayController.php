...
use App\Models\SickHoliday;
use Illuminate\Http\Request;

class SickHolidayController extends Controller
{
    /**
    ...
    {
        //
        $holiday = SickHoliday::all();

        return view('holiday.sick.index', compact('holiday'));
    }
    /**
    ...
    public function create()
    {
        ...
        return view('holiday.sick.create',compact('employee'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sick.index')->with('success', 'تم حفظ البيانات بنجاح');
    }
     ...
     *
     * @param  \App\Models\SickHoliday  $sickHoliday
     * @return \Illuminate\Http\Response
     */
    public function show(SickHoliday $sickHoliday)
    {
        //
    }
    ...
    {
        //
        $holiday = SickHoliday::find($id);
        return view('holiday.sick.edit', compact('holiday'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $holiday = SickHoliday::findOrFail($id);
        $holiday->holiday_reason = $request->input('holiday_reason');
        $holiday->employee_id = $request->input('employee_id');
        $holiday->employee_num = $request->input('employee_num');
        $holiday->holiday_place = $request->input('holiday_place');
