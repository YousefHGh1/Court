...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{route('notices.create')}}" class="btn btn-primary font-weight-bolder">
                <span class="svg-icon svg-icon-md">
                    ...
                    <!--end::Svg Icon--></span> إنشاء إخطار جديد
            </a>
            <!--end::Button-->
            @endcan
        </div>
...
<script>
    ...
    var csrf = "{{csrf_token()}}";
    var DATA_URL = "{{ route('notices.data') }}";
    var SITEURL = '{{URL::to('
    ')}}';
    var from_date = -1;
    var to_date = -1;
...
<script src="{{ asset('assets/js/pages/notices/data-json.js') }}" type="text/javascript"></script>
