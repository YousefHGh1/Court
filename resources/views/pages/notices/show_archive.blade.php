                ...
                <div class="mb-7 req_status_">
                    <div class="row align-items-center my-4">
                        <div class="col-md-3 my-md-1">
                            <h5>
                                السنة   :
                                <small class="text-muted">{{$noticeArchive->notification_year}}</small>
                            </h5>
                        </div>
                        <div class="col-md-3 my-md-1">
                            <h5>
                                رقـم الإخطار   :
                                <small class="text-muted">{{$noticeArchive->notification_number}}</small>
                            </h5>
                        </div>
                        <div class="col-md-3 my-md-1">
                            <h5>
                                رقـم الاشتراك   :
                                <small class="text-muted">{{$noticeArchive->agreement_id ? $noticeArchive->agreement_id : "  --"}}</small>
                            </h5>
                        </div>
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                الاســــــم    :
                                <small class="text-muted">{{$noticeArchive->first_name.' '.$noticeArchive->father_name.' '.$noticeArchive->family_updated}}</small>
                            </h5>
                        </div>
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                رقم الهويـــة    :
                                <small class="text-muted">{{$noticeArchive->id_card_no ? $noticeArchive->id_card_no : "  --"}}</small>
                            </h5>
                        </div>
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                رقم القضيـــــة    :
                                <small class="text-muted">{{$noticeArchive->org_file_number ? $noticeArchive->org_file_number : "  --"}}</small>
                            </h5>
                        </div>
                        ...
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                المبلغ المحكوم    :
                                <small class="text-muted">{{$noticeArchive->fine_amount}}</small>
                            </h5>
                        </div>
                        ...
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                ...
                                <small class="text-muted">{{$noticeArchive->notification_address ? $noticeArchive->notification_address : "  --"}}</small>
                            </h5>
                        </div>
                        {{--</div>--}}
                        ...
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                تاريخ الإخطار  :
                                <small class="text-muted">{{\Carbon\Carbon::parse($noticeArchive->notification_date)->format('d-m-Y h:i A')}}</small>
                            </h5>
                        </div>
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                سبــب الإخطار  :
                                <small class="text-muted">{{$noticeArchive->notification_reason}}</small>
                            </h5>
                        </div>
                        <div class="col-md-3 my-md-1 ">
                            <h5>
                                نوع الســوق  :
                                <small class="text-muted">{{$noticeArchive->rent_location_name}}</small>
                            </h5>
                        </div>
            ...
            <div  dir="rtl" id="notices_print_" style="font-size: 20px;display: none">
                ...
                <div style="display: flex">
                    <div style="margin-left: auto;">
                        <h5>إلى: <span style="text-decoration: underline;">{{$noticeArchive->first_name.' '.$noticeArchive->father_name.' '.$noticeArchive->family_updated}}</span></h5>
                    </div>
                    <div>
                        <h5>رقم هوية: <span style="text-decoration: underline;">{{$noticeArchive->id_card_no}}</span></h5>
                    </div>
                </div>

                <h5>العنوان: <span style="text-decoration: underline;">{{$noticeArchive->notification_address}}</span></h5>
                ...
                <div style="display: flex">
                    ...
                    <div>
                        <h5>بتاريخ: <span style="text-decoration: underline;">{{\Carbon\Carbon::parse($noticeArchive->notification_date)->format('d/m/Y')}}</span></h5>
                    </div>
                </div>

                <h5>نبلغك بأن تدفع لهذه الدائرة المبلغ المحكوم وقدره {{$noticeArchive->fine_amount}} شيكل</h5>

                <div style="display: flex">
                    <div style="margin-left: auto;">
                        <h5>مقابل: <span style="text-decoration: underline;">{{$noticeArchive->notification_reason}}</span></h5>
                    </div>
                    <div>
                        <h5>على حساب رقم: <span style="text-decoration: underline;">{{$noticeArchive->agreement_id}}</span></h5>
                    </div>
                </div>

                <h5>لغاية فاتورة شهر <span>{{$noticeArchive->notification_month}} / {{$noticeArchive->notification_year}} </span> بالإضافة لرسوم القضية التنفيذية.</h5>
