                ...
                <div class="card card-custom">
                            ...
                            <div class="card_print" dir="rtl">
                                ...
                                <div class="p-5 row justify-content-center">
                                    <div class="col-md-12">
                                        <!--begin::Invoice body-->
                                        <div class="pb-5 row">
                                            <div class="col-md-12 pr-md-10 py-md-10">
                                                <!--begin::عرض المراسلة-->
                                                <div
                                                ...
                                                <div class=" font-size-lg font-weight-boldest  ">
                                                    ...
                                                    الموضوع / إصدار قرار بحضور فريق تسديد القضية التنفيذية المرموقة أعلاه واحد بفك المنع من السفر عن المنفذ ضده وإشعار الجهات المختصة بذلك وفق الأصول. 
                                                ...
                                                <div class="pt-5">
                                                    ...
                                                    <h5> حيث أن / المذكور أعلاه دفع كامل المبلغ في البلدية على القضية التنفيذية المرقومة
                                                        أعلاه,
                                                        نلتمس من مقام محكمتكم الموقرة فك المنع وإشعار الجهات المختصة بذلك وفق الأصول.
                                                    </h5>
                                        ...
                                        <div class="mb-5 font-size-lg font-weight-boldest d-flex justify-content-around"
                                            ...
                                            قرار <br>
                                            أقرر إجابة الطلب مع إشعار هيئة الحدود والمعابر <br> والجهات المختصة بذلك حسب الأصول<br>
                                            قاضي التنفيذ
                    ...
                    <div class="courts_print">
                        <div dir="rtl" id="courts_print_" style="font-size: 20px;display: none">
                            ...
                            <div style="display: flex">
                                <div style="padding-right: 50%; padding-bottom: 15px;padding-top: 15px;">
                                    <u> {{ ' التفاصيل ' }}</u>
                                </div>
                            </div>
                            ...
                            <div style="display: flex ">
                                ...
                                <div class="mb-1 font-size-lg font-weight-bold ">
                                    ...
                                    <h3> حيث أن / المذكور أعلاه دفع كامل المبلغ في البلدية على القضية التنفيذية المرقومة
                                        أعلاه.<br />
                                        نلتمس من مقام محكمتكم الموقرة فك المنع من السفر وإشعار الجهات المختصة بذلك وفق الأصول.
                                    </h3>
                            ...
                            <div style="display: flex ">
                                ...
                                <div style="text-align: center;padding-top:20%">
                                    ...
                                    <h4> أقرر إجابة الطلب مع إشعار هيئة الحدود والمعابر <br> والجهات المختصة بذلك حسب الأصول<br>
                                        قاضي التنفيذ
                                    </h4>
                                </div>
                            </div>
                            ...
                            <div style="display: flex ">
                                ...
                                <div class="bottom-left" style="text-align: center; float:left">
                                    <h4> توقيع ممثل المستدعية / طالبة التنفيذ</h4>
