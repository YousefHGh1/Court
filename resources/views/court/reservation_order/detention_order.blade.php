                                ...
                                <div class="p-5 row justify-content-center">
                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-8 border-right-md pr-md-10 py-md-10">
                                                ...
                                                <div class=" font-size-lg font-weight-boldest  ">
                                                    {{-- <textarea name="" id="" cols="110" rows="6"> --}}
                                                        الموضوع : إصدار قرار بحضور فريق واحد باصدار أمر حبس على المستدعى ضده في القصية
                                                ...
                                                <div class="pt-5">
                                                    ...
                                                    <ol class="font-weight-boldest mr-5">
                                                        <li>حيث أن المستدعية اقامت القضية
                                                            التنفيذية المرقومة أعلاه .</li>

                                                        <li>حيث ان المستدعي ضده لم يلتزم بدفع قيمة القضية
                                                            التنفيذية المرقومة أعلاه .
                                                        </li>
                                                    </ol>
                                                    ...
                                                    <h4>إصدار قرار بحضور
                                                        ...
                                                        القصية التنفيذية المرقومة أعلاه</h4>
                                        ...
                                        <div class="mb-5 font-size-lg font-weight-boldest d-flex justify-content-around"
                                            style="text-align: left; margin-right: 80%">

                                            <div class="font-weight-boldest">

                                                <h4> توقيع ممثل المستدعية / طالبة التنفيذ
                                                </h4>
                        ...
                        <div dir="rtl" id="courts_print_" style="font-size: 20px;display: none">
                            ...
                            <div style="display: flex">
                                ...
                                <div style="padding-right: 10px; padding-bottom: 15px;padding-top: 15px;">
                                    {{ ' الموضوع / إصدار قرار بحضور فريق واحد باصدار أمر حبس على المستدعى ضده في القصية
                                    التنفيذية المرقومة أعلاه' }}</div>
                            </div>

                            <div class="pt-5">

                                <center>
                                    <h3><strong>التفاصيل</strong></h3>
                                </center>
