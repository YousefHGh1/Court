                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <input type="number" class="form-control @error('jibaya_id') is-invalid @enderror"
                                    name="jibaya_id" required
                                    oninvalid="this.setCustomValidity('يرجى إدخال رقم اشتراك الجباية')"
                                    oninput="this.setCustomValidity('')" value="{{old('jibaya_id')}}"
                                    placeholder="رقم اشتراك الجباية" />
                                @error('jibaya_id')
                                    ...
                                    <div data-repeater-item class="form-group row align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" required
                                                oninvalid="this.setCustomValidity('يرجى إدخال اسم المدعي')"
                                                oninput="this.setCustomValidity('')" name="summoner"
                        ...
                        <div id="kt_repeater_4" style="position: relative">
                            <div class="row">
                                ...
                                <div data-repeater-list="defendant" class="col-lg-10">
                                    <div data-repeater-item class="form-group row align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" required
                                                oninvalid="this.setCustomValidity('يرجى إدخال اسم المستدعى ضده')"
                                                oninput="this.setCustomValidity('')" name="defendant"
                                                placeholder="الاسم رباعي" />
                                            <div class="d-md-none mb-2"></div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="number" class="form-control" name="idno_defendant"
                                        value="{{ $defendant->idno }}" readonly />
                                    <div class="d-md-none mb-2"></div>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control"
                                        value="{{ getDefendantName($defendant->idno) }}" readonly />
                                    <div class="d-md-none mb-2"></div>
                                </div>
                                <div class="col-md-1">
                                    <a href="javascript:;" data-repeater-delete=""
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <input type="number" class="form-control @error('amount') is-invalid @enderror" required
                                    oninvalid="this.setCustomValidity('يرجى إدخال  المبلغ')"
                                    oninput="this.setCustomValidity('')" name="amount" value="{{old('amount')}}"
