                                        ...
                                        <div class="pb-5 row">
                                            <div class="col-md-12 pr-md-10 py-md-10">
                                                ...
                                                <div class=" font-size-lg font-weight-boldest  ">
                                                    ...
                                                    الموضوع / إصدار قرار بحضور فريق واحد يقضي دفع كامل المبلغ في القضية
                                                    التنفيذية
                                                ...
                                                <div class="pt-5">
                                                    ...
                                                    <h6> حيث أن / المذكور أعلاه دفع كامل المبلغ على القضية التنفيذية
                                                        أعلاه وحيث أنه أنهى تسديد مستحقات البلدية حسب القضية المرموقة
                                                        أعلاه
                                                    </h6>
                    ...
                    <div class="courts_print">
                        <div dir="rtl" id="courts_print_" style="font-size: 20px;display: none">
                            ...
                            <div style="display: flex">
                                ...
                                <div style="padding-right: 80px; padding-bottom: 15px;padding-top: 15px;">
                                    {{ ' الموضوع / إصدار قرار بحضور فريق واحد يقضي دفع كامل المبلغ في القضية التنفيذية '
                                    }}</div>
                            </div>
                            ...
                            <div style="display: flex ">
                                ...
                                <div class="mb-5 font-size-lg font-weight-bold ">
                                    ...
                                    <h4>حيث أن / المذكور أعلاه دفع كامل المبلغ على القضية التنفيذية أعلاه وحيث أنه أنهى
                                        تسديد مستحقات البلدية حسب القضية المرموقة أعلاه
                                        <br>
                                        <br>
                                        <br>
                            ...
                            <div style="display: flex ">
                                ...
                                <div style="text-align: center;padding-top:20%">
                                    ...
                                    <h4> أقرر إجابة الطلب بذلك حسب الأصول
                                        <br>
                                        قاضي التنفيذ
