            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ url('/holiday/sick') }}" class="btn btn-primary font-weight-bolder">
                ...
                <!--begin::Form-->
                <form action="{{ route('sick.store') }}" method="post" class="form needs-validation " novalidate
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-11">
                            ...
                            <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                <h3 class="text-dark font-weight-bold mb-10">بيانات الاجازة المرضية</h3>
