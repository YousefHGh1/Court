            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ url('/holiday/external') }}" class="btn btn-primary font-weight-bolder">
                ...
                <!--begin::Form-->
                <form action="{{route('external.store')}}" method="post" class="form needs-validation " novalidate
