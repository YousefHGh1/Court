    ...
    <div class="card card-custom">
        <div class="flex-wrap pb-0 border-0 card-header">
            <div class="card-title">
                <h3 class="card-label"> قائمة الإجازات الخارجية</h3>
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ url('/holiday/external/create') }}" class="btn btn-primary font-weight-bolder">
                    ...
                    <tr>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            ...
                            <span style="overflow: visible; position: relative; width: 110px;">
                                ...
                                <a href="{{ url('/holiday/external/' . $holidays->id) }}" title="View holiday"><button
                                ...
                                <form method="POST" action="{{ url('/holiday/external' . '/' . $holidays->id) }}"
                                ...
                                <a href="{{ url('/holiday/external/' . $holidays->id . '/edit') }}"
