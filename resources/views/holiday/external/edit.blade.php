            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label"> تعديل الإجازات الخارجية <i class="mr-2"></i></h3>
                    </div>

                </div>
                <!--begin::Form-->
                <form action="{{ route('external.update',$holiday->id) }}" method="post" class="form needs-validation "
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-11">
                            ...
                            <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                <h3 class="text-dark font-weight-bold mb-10">بيانات الاجازة الخارجية</h3>
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="holiday_reason" name="holiday_reason">
                                                <option value="{{ $holiday->holiday_reason  }}" {{$holiday->
                                                    holiday_reason == $holiday->holiday_reason ? 'selected' : ''}}>{{
                                                    $holiday->holiday_reason}}</option>
                                            ...
                                            <div class="col-lg-7">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="remaining_balance"
                                                        ...
                                                        value="{{ $holiday->remaining_balance }}" />
