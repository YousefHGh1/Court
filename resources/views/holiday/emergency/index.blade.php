    ...
    <div class="card card-custom">
        <div class="flex-wrap pb-0 border-0 card-header">
            <div class="card-title">
                <h3 class="card-label"> قائمة الإجازات الطارئة</h3>
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ url('/holiday/emergency/create') }}" class="btn btn-primary font-weight-bolder">
            ...
            <table id="example" class="table dt-responsive" style="width:100%; padding:0%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="5%">{{ $holidays->holiday_balance }}</td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            ...
                            <span style="overflow: visible; position: relative; width: 110px;">
                                ...
                                <a href="{{ url('/holiday/emergency/' . $holidays->id) }}" title="View holiday"><button
                                ...
                                <form method="POST" action="{{ url('/holiday/emergency' . '/' . $holidays->id) }}"
                                ...
                                <a href="{{ url('/holiday/emergency/' . $holidays->id . '/edit') }}"
