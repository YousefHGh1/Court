...
@section('sub_title')
اضافة بيانات المتدربين والمتطوعين
@endsection
...
<div class="container">
    <div class="card-toolbar pb-5">
        <!--begin::Button-->
        <a href="{{ url('/volanteer') }}" class="btn btn-primary font-weight-bolder">
            <span class="svg-icon svg-icon-md">
                ...
                <!--end::Svg Icon-->
            </span>عرض قائمة المتطوعين / المتدربين
        </a>
        <!--end::Button-->
    </div>
    <!--begin::Card-->
                    ...
                    <div class="card-body p-0">
                        <div class="row justify-content-center px-8 py-8 ">
                            <div class="col-xl-12 col-xxl-12">
                                <!--begin::Wizard ***************************************************Form***********************************************************************-->
                                <form action="{{route('volanteer.store')}}" method="post" class="form needs-validation"
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-12">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="input-group ">
                                                                    ...
                                                                    <input type="email"
                                                                        ...
                                                                        name="volanteer_email" id="volanteer_email" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg "
                                                                placeholder="الاسم بالكامل" name="volanteer_name"
                                                                id="volanteer_name" />
                                                            ...
                                                            <div class="col-8 col-form-label">
                                                                <div class="radio-inline">
                                                                    <label class="radio radio-primary pr-5 pl-5"
                                                                        ...
                                                                        <input type="radio" name="volanteer_gender"
                                                                            value="ذكر" id="volanteer_gender" />
                                                                        <span></span>
                                                                        ذكر
                                                                    </label>
                                                                    <label class="radio radio-primary"
                                                                        style="font-size: 1.3rem">
                                                                        <input type="radio" name="volanteer_gender"
                                                                            value="أنثى" id="volanteer_gender" />
                                                                        <span></span>
                                                                        أنثى
                                                                    </label>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-lg "
                                                                        placeholder="العنوان" name="volanteer_address"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="input-group ">
                                                                    ...
                                                                    <input type="number"
                                                                        class="form-control form-control-lg "
                                                                        placeholder="موبايل" name="volanteer_mobile"
                                                                        id="volanteer_mobile" />
                                                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-lg "
                                                                        placeholder="التخصص" name="volanteer_major"
                                                                        id="volanteer_major" />
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <!--begin::Wizard Step 2-->
                                            <div class="pb-5" data-wizard-type="step-content">
                                                <h5 class="text-dark font-weight-bold mb-10 mt-5">بيانات المتدرب/المتطوع
                                                    الأساسية
                                                </h5>
                                                <!--begin::Group-->
                                                <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number"
                                                                        class="form-control form-control-lg"
                                                                        name="volanteer_duration"
                                                                        id="volanteer_duration" placeholder="مدته" />
                                                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="input-group ">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-lg "
                                                                        placeholder="مجال التطوع/التدريب" name="named"
                                                                        id="named" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="input-group ">
                                                                    ...
                                                                    <input type="date"
                                                                        class="form-control form-control-lg"
                                                                        name="volanteer_start_date"
                                                                        id="volanteer_start_date" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
